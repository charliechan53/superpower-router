...
3. Add a routing decision and exact runner command per task:
   - Codex CLI (`gpt-5.3-codex`) for repository exploration, implementation, refactor, tests, and review.
   - Codex CLI (`gpt-5.4`) for logic review, analysis, and reasoning tasks.
   - Claude native WebSearch/WebFetch for live web/docs research.
...
5. Do not use Claude-native `Explore` or `Task` subagents for Codex-eligible work while writing the plan.
